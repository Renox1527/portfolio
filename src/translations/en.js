export default {
  ...
  home: {
  title: "Hi, I'm Reny, front-end developer.",
  
  subtitle: "Front-end developer focused on creating clean, functional, and scalable interfaces with HTML/CSS, Bootstrap, Laravel, WordPress, React, and JavaScript.",
},
  ...
  description: `I am a front-end developer in training, focused on creating clean, functional, and well-structured user interfaces.
                  
  I currently continuing to learn how to work with React and modern JavaScript,
  and I have experience using the Laravel framework.
  ...
  title: "Projects",
  intro:
    "These projects reflect my professional experience and continuous learning process.",
  main: {
